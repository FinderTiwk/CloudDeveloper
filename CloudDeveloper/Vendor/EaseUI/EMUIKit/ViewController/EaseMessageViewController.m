            ...
            if ([[UIDevice currentDevice].systemVersion doubleValue] >= 9.0f) {
                ...
                [alasset assetForURL:url resultBlock:^(ALAsset *asset) {
                    if (asset) {
                        ...
                        Byte* buffer = (Byte*)malloc((int)[assetRepresentation size]);
                        NSUInteger bufferSize = [assetRepresentation getBytes:buffer fromOffset:0.0 length:(int)[assetRepresentation size] error:nil];
